...
module Autoparts
  module Packages
    class GoogleAppEngine < Package
      ...
      source_url 'https://commondatastorage.googleapis.com/appengine-sdks/featured/google_appengine_1.9.3.zip'
      source_sha1 '4d4a535604a05bda3972c1abff6289f9b2ed9bfd'
      source_filetype 'zip'
