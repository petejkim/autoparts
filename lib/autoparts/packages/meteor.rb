...
module Autoparts
  module Packages
    class Meteor < Package
      ...
      source_url 'https://d3sqy0vbqsdhku.cloudfront.net/packages-bootstrap/0.9.0.1/meteor-bootstrap-os.linux.x86_64.tar.gz'
      source_sha1 'ad2c344f78a3641a00546e023aea0efc9bacd672'
