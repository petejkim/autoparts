module Autoparts
  module Packages
    class GoogleAppEngineGo < Package
      ...
      source_url 'https://storage.googleapis.com/appengine-sdks/featured/go_appengine_sdk_linux_amd64-1.9.13.zip'
      source_sha1 'aa67ac85debc1ea9e332ac7382850e81c385cc63'
      source_filetype 'zip'
